...
\newline\small\scriptsize{\textsf{The sample is restricted to women in either nuclear or patrilocal extended household structures, and women who report being three or more months pregnant at the time of the survey.}}
...
\begin{center}
\includegraphics[scale=0.26, angle=90]{figures/figure 1 regression coefficients with and without controls.png}
\end{center}
...
\begin{center}
\begin{scriptsize}
\begin{adjustbox}{angle=90, max width=\textheight, max totalheight=\textwidth, keepaspectratio}
\setlength{\tabcolsep}{6pt}
...
\begin{center}
\includegraphics[scale=0.55, angle=90]{figures/apdx bar graph three panel.png}
\end{center}
