...
\vspace{1ex}
\newline\small\scriptsize{\textsf{\textit{Note}: Data are from NFHS rounds 3, 4, and 5. Significance stars indicate differences between nuclear and patrilocal extended households within survey round: *$p<0.1$, **$p<0.05$, ***$p<0.001$. 
The pregnant sample includes ever-married women who report being three or more months pregnant at the time of the survey and who were asked the decision-making questions 
``Who usually makes decisions about healthcare for yourself?'' and 
``Who usually makes decisions about visits to your family or relatives?'' 
The outcomes ``No say in own healthcare'' and ``No say in visits to family/friends'' are constructed from these questions. 
The recent birth sample includes ever-married women who gave birth 3--12 months before the survey.}}
