...
label var outcome_id  "Outcome id"
label var mean        "Mean"
...
local N2005 : display %5.0fc r(sum)

quietly summarize N if nfhs_round==4, meanonly
local N2015 : display %5.0fc r(sum)

quietly summarize N if nfhs_round==5, meanonly
local N2020 : display %5.0fc r(sum)
...
graph save "Graph" "figures/figure 2 panel A.gph"
...
graph save "Graph" "figures/figure 2 panel B.gph"
