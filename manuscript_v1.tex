...
\begin{figure}[H]
    ...
    \label{fig:bargraph}
    \parbox{1\linewidth}{\footnotesize The sample used in \cite{allendorf2012women} includes women who are currently married, living with their husband, between the ages of 15 and 29, usual residents of their household, and living in either nuclear or patrilocal extended household structures.}
\end{figure}
