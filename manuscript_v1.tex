...
\begin{table}[!htbp]
    ...
    \begin{threeparttable}[t]
        ...
        \begin{tablenotes}
            \item Data is from NFHS rounds 3, 4, and 5.
            \item *$p<0.1$, **$p<0.05$, ***$p<0.001$
            \item The sample of currently pregnant women includes women who report being three or more months pregnant at the time of the survey. The recently given birth sample includes women who gave birth 3-12 months before the survey. 
        \end{tablenotes}
    \end{threeparttable}
\end{table}
\end{landscape}
...
\begin{figure}[H]
    ...
    \parbox{1\linewidth}{\footnotesize Data is from NFHS rounds 3, 4, and 5. Points represent the coefficient $\beta$ on the patrilocal household indicator from linear probability models shown in equations \ref{eq:nocontrols} and \ref{eq:controls}. Intervals represent 95\% confidence intervals on $\beta$. Panels A and B use the sample of women who gave birth 3-12 months before the survey. Panels C and D use the sample of women who report being three or more months pregnant at the time of the survey.}
\end{figure}
...
\begin{table}[!htbp]
    ...
    \begin{threeparttable}[t]
        ...
        \begin{tablenotes}
            \item Data is from NFHS rounds 3, 4, and 5.
            \item *$p<0.1$, **$p<0.05$, ***$p<0.001$
            \item $^1$ Uses the sample of women who report being 3 or more months pregnant at the time of the survey.
            \item $^2$ Uses the sample of women who report having given birth 3 to 12 months before the survey.
        \end{tablenotes}
    \end{threeparttable}
\end{table}
...
\begin{figure}[H]
    ...
    \label{fig:bargraph}
    \parbox{1\linewidth}{\footnotesize Data is from the NFHS rounds 3, 4, and 5. Panel A uses the sample of women who report being 3 or more months pregnant at the time of the survey. Panel B uses the sample of women who do not report being pregnant at the time of the survey. Panel C has no sample restrictions.}
\end{figure}
...
\begin{table}[H]
    ...
    \begin{threeparttable}[t]
        ...
        \begin{tablenotes}
            \item Data is from the NFHS rounds 3, 4, and 5. 
            \item The sample is restricted to ever-married women who report being three or more months pregnant at the time of the survey, and those who are living in either nuclear or patrilocal extended households. 
            \item The sample is also restricted to women residing in either nuclear or patrilocal extended household structures. 
