...
To assess whether increases in extended family residence were more common among certain groups of women, we construct variables that measure a pregnant woman's caste, region, age and parity. 
...
The sample used for analysis in this paper focuses on women who live in either nuclear or patrilocal joint household structures. 

We exclude women living in natal households from the sample, as this living arrangement represents a substantively different social context from both patrilocal and nuclear households.

Figure \ref{fig:bargraph} shows the composition of household structure in different samples of women. Where applicable, it keeps the subsample of women in natal households to show that its proportion remains stable over time, and its exclusion does not affect trends in nuclear and patrilocal joint household structures.
...
\begin{figure}[H]
    ...
    \label{fig:bargraph}
    \parbox{1\linewidth}{\footnotesize The sample used in \cite{allendorf2012women}}
\end{figure}
