...
\begin{figure}[H]
    ...
    \parbox{1\linewidth}{\footnotesize Data is from NFHS rounds 3, 4, and 5. Points represent the coefficient $\beta$ on the patrilocal household indicator from linear probability models shown in equations \ref{eq:nocontrols} and \ref{eq:controls}. Intervals represent 95\% confidence intervals. Panels A and B use the sample of women who gave birth 3-12 months before the survey. Panels C and D use the sample of women who report being three or more months pregnant at the time of the survey.}
\end{figure}
