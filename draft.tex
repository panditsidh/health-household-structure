...
\begin{figure}[H]
    ...
    \caption{: trends in hh struc over time}
\end{figure}
...
\begin{table}[H]
    ...
    \begin{threeparttable}[t]
        \caption{: Percentage of pregnant women living in patrilocal extended families as opposed to nuclear families}
...
\begin{table}[H]
    ...
    \begin{threeparttable}[t]
        ...
        \input{tables/coefficient_table}
