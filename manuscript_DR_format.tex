...
\newline\small\scriptsize{Stars indicate the statistical significance of the difference between the 2005--2006 and 2019--2021 estimates. P-values are from weighted linear probability models regressing patrilocal extended household residence on an indicator for 2019--2021, restricted to the relevant subgroup. Standard errors are clustered at the primary sampling unit level. \textsf{*$p<0.10$, **$p<0.05$, ***$p<0.01$}}
...
\vspace{1ex}
\small\scriptsize{\textsf{\textit{Note}: Data is from NFHS rounds 3, 4, and 5.}}
\newline\small\scriptsize{\textsf{*$p<0.10$, **$p<0.05$, ***$p<0.01$}}
...
\begin{flushleft}
\captionsetup{style=CAPFIG}
\caption{Household structure among married men whose wife is currently pregnant.}
