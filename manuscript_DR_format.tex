...
\begin{center}
\includegraphics[scale=0.7]{figures/apdx bar graph three panel.pdf}
\end{center}
...
\begin{center}
\includegraphics[width=0.6\textwidth]{figures/apdx bar graph three panel men.png}
\end{center}
...
\begin{center}
\includegraphics[width=0.6\textwidth]{figures/DR/allendorf sample bar graph.png}
\end{center}
\label{fig:allendorf}
\vspace{1ex}
