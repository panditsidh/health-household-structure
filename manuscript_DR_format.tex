...
Chat-GPT was prompted to follow a specified structure of pseudocode and previously written code by the researchers (without AI assistance) to generate new code that was later manually verified and adjusted by the researchers before being used to create tables and figures and display them in LaTeX.
...
\refstepcounter{section}
\subsection*{B. Justification of decision to drop women reporting 1 or 2 months of pregnancy} \label{sec:dropearlypregnancy}
...
\sffamily
\captionsetup{style=CAPTAB}
\caption{\hspace{-.99em}: Women reporting 1 or 2 months of pregnancy differ from women reporting later pregnancy}
