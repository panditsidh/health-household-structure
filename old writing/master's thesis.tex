...
\begin{titlepage}
    ...
    \textbf{Extended family residence and pregnant women's autonomy and healthcare in India: A Research Note}\\[3em]
...
\noindent
I am deeply grateful to my advisor Professor Diane Coffey, for her constant guidance, encouragement and thoughtful feedback throughout the project. Her insights have shaped both the direction and clarity of this thesis. I would also like to thank my co-author for his support and helpful discussion which had greatly improved this work. I am grateful to the Department of Sociology at the University of Texas at Austin for providing a supportive academic environment. I acknowledge the National Family Health Survey (NFHS) data program for making these data publicly available, that made this research possible. Finally, I would like to thank my partner, family, and friends for their unwavering support and patience throughout this process. 
...
\begin{center}
\textbf{Extended family residence and pregnant women’s autonomy and health in India: A Research Note} \\
\vspace{1em}
Bipasa Banerjee, MA \\
The University of Texas at Austin, 2026 \\
Supervisor: Diane Coffey
\end{center}

\vspace{2em}

\noindent
This paper examines how household structure shapes pregnant women's autonomy and maternal healthcare use in India using the National Family Health Survey (NFHS) data from years 2005, 2014 and 2021. Across all survey rounds, pregnant women in nuclear households have greater decision making power than those in patrilocal joint households, but are less likely to use maternal healthcare services. Over the past two decades, these differences have narrowed, reflecting improvements in access to maternal healthcare and increases in women's autonomy across household types. In contrast to earlier evidence of a shift toward nuclear households, we document a reversal of this trend among pregnant women who are less likely to reside in nuclear households in 2021 than in 2005. Joint households remain wealthier, and economic resources explain a significant portion of the gap in healthcare use, although not entirely. These findings show that lower decision making power does not necessarily translate into lower maternal healthcare use, which is shaped by distinct mechanisms, particularly household resources. 
...
This paper builds upon and dialog with prior empirical research by \cite{allendorf2013going}, who uses 1992 to 2005 data from India to show that several women's health outcomes were positively associated with joint, rather than nuclear family, residence, during that period.  \cite{allendorf2013going}'s paper noted an approximately 8 percentage point increase in the proportion of young women living in nuclear households between 1992 and 2005, and raised the question of how, considering the joint family health advantages that she documented, the shift towards nuclear families might impact women's health in the future.  In contrast, our research, which specifically focuses on pregnant women, finds that in the last two decades, the trend towards nuclear households has reversed.  Pregnant women are actually 8 percentage points less likely to be living in nuclear households in 2021 than they were in 2005. It is important to note here that there has been a fertility decline over this period as reflected in our decomposition (see appendix table \ref{tab:proppatrilocal}) a higher share of women are in their first parity than earlier. However, one thing that remains consistent with the period \cite{allendorf2013going} studied is that joint families are still wealthier than nuclear families, and wealth is a mediator that explains part of the observed gap between patrilocal and nuclear households in facility births and prenatal care. Although including wealth controls in a regression of maternal care use on household type significantly reduces the magnitude of differences across household type, it does not eliminate them entirely.
...
To assess sociodemographic difference in the pattern of residences, we looked into proportion of pregnant women living in joint households across caste, region, age and parity. 
...
In all models, we report standard errors clustered at the primary sampling unit level to account for within-cluster correlation of outcomes.  $\lambda_{g(i)}$ denotes wealth-group fixed effects, where groups are defined by the full interaction of eight household asset ownership indicators outlined in \ref{sec:wealthcontrols}. $\mu_s$ denotes state fixed effects.\footnote{All models account for the NFHS complex survey design using sampling weights and stratification.}
