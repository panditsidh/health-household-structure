...
twoway 
    ...
    aspect(0.7)
	caption("1998–99: `round21' pregnant, 2005–06: `round31' pregnant" ///
...
// 	graphregion(color(white))
// 	aspect(0.7)
// 	by(preg, col(2) legend(on pos(6)) ///
// 		caption("1998–99: `round21' pregnant, `round20' nonpregnant, 2005–06: `round31' pregnant, `round30' nonpregnant" ///
// 				"2015–16: `round41' pregnant, `round40' nonpregnant, 2019–21: `round51' pregnant, `round50' nonpregnant"));
//
// #delimit cr
//
// graph save "`ylab'", replace
// graph export "`ylab'.png", as(png) replace
