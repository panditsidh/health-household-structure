...
foreach file in nfhs2hmr nfhs3hmr nfhs4hmr nfhs5hmr {
	use hvidx hv000 hv001 hv002 hhid hv101 hv104 hv105 hv115 using $`file'
	tempfile `file'
	save ``file''
} 

use hvidx hv000 hv001 hv002 hhid hv101 hv104 hv105 using $nfhs1hmr
append using `nfhs2hmr'
append using `nfhs3hmr'
...
label define hh_struc_lbl 1 "Nuclear" 2 "Patrilocal extended" 3 "Natal" 4 "Downwardly extended" 5 "Unclassified polygamous" 6 "Domestic worker"
label values hh_struc hh_struc_lbl

gen missing_hhstruc = missing(hh_struc)

gen round = 1 if v000=="IA2"
replace round = 2 if v000=="IA3"
